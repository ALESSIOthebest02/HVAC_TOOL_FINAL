...
st.title("⚡ HVAC Tool - Versione Estrazione Forzata")

# 🧨 Estrazione forzata senza condizioni
zip_name = "pkl-20250602T084740Z-1-001.zip"
try:
    with zipfile.ZipFile(zip_name, 'r') as zip_ref:
        zip_ref.extractall()
    st.success("✅ File ZIP estratto correttamente.")
except Exception as e:
    st.warning(f"⚠️ Errore durante l'estrazione: {e}")

# 🔎 Mostra file presenti per debug
st.write("📁 File presenti nella cartella:", os.listdir())
